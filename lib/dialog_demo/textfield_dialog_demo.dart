...
import 'package:flutter_demo_project/dialog_demo/textfield_controller.dart';
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Text('Cricket'),
                    Checkbox(
                      value: TextAlertController.isFootball,
                      onChanged: (value) {
                        TextAlertController.isFootball = value!;
                        setState(() {});
                      },
                    ),
                    const Text('Football'),
                ...
                MaterialButton(
                    ...
                    child: RichText(
                      text: const TextSpan(
                          ...
                          style: TextStyle(
                              fontSize: 30,
                              color: Color.fromARGB(255, 75, 46, 3)),
                          children: [
                            TextSpan(
                                text: 'bm',
                                style: TextStyle(
                                    color: Color.fromARGB(255, 131, 19, 19))),
                            TextSpan(
                                text: 'it',
                                style: TextStyle(
                                    color: Color.fromARGB(255, 3, 109, 7))),
                          ]),
                    )),

...
import 'package:flutter_demo_project/stateful_widget_practice/gender_ui_controller.dart';
...
class _GenderFormUiDemoState extends State<GenderFormUiDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: OnSubmit.isSubmitted == true
          ? const Color.fromARGB(255, 227, 162, 184)
          : Colors.white,
      body: Padding(

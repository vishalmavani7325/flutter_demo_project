...
class InstaModelDemo extends StatelessWidget {
  const InstaModelDemo({super.key});

  @override
  Widget build(BuildContext context) {
    for (var element in userInstaDetails) {
      userInstaData.add(UserInsta.fromJson(element));
    }
    return Scaffold(
      body: Column(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage(userInstaData[index].url!),
                          ),
                          border: Border.all(
                            color: Colors.red,
                            strokeAlign: 10,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    image: DecorationImage(
                                      image:
                                          AssetImage(userInstaData[index].url!),
                                    ),
                                    color: Colors.pink,
